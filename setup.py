...
setup(
    ...
    name='ICGC-data-parser',  # Required
    ...
    description='Tools to facilitate the parsing of SSM data from the International Cancer Genome Consortium data releases, in particular, the simple somatic mutation aggregates.',  # Required
    ...
    url='https://github.com/Ad115/ICGC-data-parser',  # Optional
