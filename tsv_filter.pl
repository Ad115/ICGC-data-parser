...
Usage: ./tsv_filter.pl --in=<tsvfile> [--out=<outfile>] [--fields] [--help]
...
Command-line arguments:
	--in -> Name of the input tsv file, the only required argument
	--out -> Name of the output file
	--fields -> If present, only show column titles
	--help -> Show this text
	
Author: Andrés García García @ Jul 2016
...
if($help or !$tsvfile_name)	{ die $doc_str; }
